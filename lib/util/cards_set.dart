...
final cardWidgets = <MiniCardWidget>[
  ...
  MiniCardWidget(imageLink: 'assets/images/13.png', cardId: CardIdEnum.thirteen),
  MiniCardWidget(imageLink: 'assets/images/21.png', cardId: CardIdEnum.twentyone),
  MiniCardWidget(imageLink: 'assets/images/40.png', cardId: CardIdEnum.forty),
  MiniCardWidget(imageLink: 'assets/images/100.png', cardId: CardIdEnum.hundred),
  MiniCardWidget(imageLink: 'assets/images/unclear.png', cardId: CardIdEnum.unknown),
  MiniCardWidget(imageLink: 'assets/images/break.png', cardId: CardIdEnum.tea),
  MiniCardWidget(imageLink: 'assets/images/back.png', cardId: CardIdEnum.back),
];